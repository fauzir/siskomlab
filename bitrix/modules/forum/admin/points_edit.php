...
$aMenu = array(
	array(
		...
		"LINK" => "/bnpt/admin/forum_points.php?lang=".LANG."&".GetFilterParams("filter_", false),
		"ICON" => "btn_list",
	)
);
...
if ($ID > 0 && $forumPermissions == "W")
{
	...
	$aMenu[] = array(
		...
		"LINK" => "/bnpt/admin/forum_points_edit.php?lang=".LANG."&".GetFilterParams("filter_", false),
		"ICON" => "btn_new",
	);

	$aMenu[] = array(
		"TEXT" => GetMessage("FPN_DELETE_POINT"),
		"LINK" => "javascript:if(confirm('".GetMessage("FPN_DELETE_POINT_CONFIRM")."')) window.location='/bnpt/admin/forum_points.php?action=delete&ID[]=".$ID."&lang=".LANG."&".bitrix_sessid_get()."#tb';",
		"ICON" => "btn_delete",
	);
}
...
$tabControl->Buttons(
	array(
		...
		"back_url" => "/bnpt/admin/forum_points.php?lang=".LANG."&".GetFilterParams("filter_", false)
	)
);
$tabControl->End();
?>
