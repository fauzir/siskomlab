...
<script type="text/javascript">
    ...
    var arFilter = <?php echo CUtil::PhpToJSObject($arResult["GET_LIST_PARAMS"]["legacyFilter"])?>;
...
<?php $APPLICATION->IncludeComponent(
	...
	array(
		...
		'USE_EXPORT' => ($arParams['MARK_ACTIVE_ROLE'] == 'Y' || $arParams['MARK_SECTION_ALL'] == 'Y') ? 'Y' : 'N', // export on role pages and all
