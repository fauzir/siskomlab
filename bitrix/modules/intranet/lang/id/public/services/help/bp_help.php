...
      process) as well as variable or status-driven processes. Hal ini
...
  essence is a simple visual <b>drag and drop</b>  block creator. Bisnis
  process templates are created in a specialized version of the visual editor. Se
...
DokumentasiA status here is not just a marker concerning
...
MemprosesA typical scheme for such processes consists of several statuses
...
 
  <p>The most common business processes are included in junior editions (<b>Bitrix Intranet: Office Edition</b> and <b>Bitrix Intranet: Extranet Edition</b>) as read-only constructions. Kamu bisa
...
EditorThe type can be selected using the context toolbar controls of the <b>Business
  Process Templates</b> form.</p>
 
  <p>The first step in creating a business process is to define the parameters. Itu
...
TindakanHaving added a command, configure its parameters. Each command has a
