...
$MESS["INTRANET_USTAT_TELLABOUT_LIKES_TITLE"] = "gue like it! gue like it! gue like it!";
...
 
To make sure that your files are always available to your colleagues, we recommend using the Bitrix24.Jalan. This is a file sync application that sits inside the Bitrix Desktop App. Your local files will be synchronized with the Bitrix24 intranet document library.
 
