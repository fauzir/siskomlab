...
<?php
if(array_key_exists('maxyc', $_GET))
{
	$ls = CTaskListState::getInstance(1);

	print_r(array(
		'VIEW' => CTaskListState::getViewName($ls->getViewMode()),
		'ROLE' => CTaskListState::getRoleName($ls->getUserRole()),
		'SECTION' => \CTaskListState::resolveConstantCodename($ls->getSection()),
		'CATEGORY' => CTaskListState::getTaskCategoryName($ls->getTaskCategory()),
	));
