...
$MESS["VI_TRIAL_G_P1"] = "If you are getting more and more inbound calls, distribute them across different employees and different queues:";
$MESS["VI_TRIAL_G_F1"] = "Add more than three employees to a queue";
$MESS["VI_TRIAL_G_F2"] = "Create multiple groups (queues) and specify to auto distribute calls";
$MESS["VI_TRIAL_G_P2"] = "To add more than three employees to a queue, create multiple groups and enjoy other productivity tools, upgrade to \"Plus\" plan today!";
