...
div.innerHTML = div.innerHTML + \'<div class="pulse-close-btn" id="pulse-close-btn"></div>\' +
	...
	\'<div class="pulse-loading-first-anim-title">Perusahaan Pulse</div>\'+
	...
	\'</div>\'+
	\'<div class="pulse-loading-first-anim-text">Pemuatan...</div>\'+
	\'</div>\';
...
function loadIntranetUstatRating(parameters)
{
	...
	if (data.OFFSET == 0)
	{
		BX(\'pulse-cont-\'+data.LIST).innerHTML = \'<div id="ustat-rating-loading">Pemuatan...</div>\';
	}
	...
	<table class="sidebar-pulse-table">
		<tr>
			<td class="sidebar-pulse-cell-l">
				<div class="sidebar-pulse-text">Perusahaan Pulse</div>
			</td>
			<td class="sidebar-pulse-cell-r">
				<div class="sidebar-pulse-nums">
					<div class="sidebar-pulse-counter" title="Tingkat aktivitas perusahaan saat ini (gabungan semua pengguna dalam satu jam terakhir)"><span id="pulse-cnt"></span><!--\'start_frame_cache_pulse-cnt\'-->0<!--\'end_frame_cache_pulse-cnt\'--><div class="sidebar-pulse-counter-line"></div>
					</div>
					<div class="sidebar-pulse-percent" title="Keterlibatan pengguna saat ini. Ini menunjukkan persentase semua pengguna saat ini yang telah menggunakan setidaknya empat alat berbeda di intranet."><span id="pulse-rate"></span><!--\'start_frame_cache_pulse-rate\'-->0<span class="sidebar-pulse-percent-icon">%</span><!--\'end_frame_cache_pulse-rate\'--><div class="sidebar-pulse-percent-bg"></div>
					</div>
				</div>
			</td>
		</tr>
...
var pulse_popup = {
	...
	toggle_links_text:[\'Peringkat umum\', \'Tidak terlibat\'],
