...
else
{
	...
	class Support extends Network
	{
		...
		const MD5_CODE = "4df232699a9e1d0487c3972f26ea8d25";
		...
		public static function register(array $params = Array())
		{
			...
			$botId = parent::join(self::MD5_CODE);
		...
		public static function unRegister($code = '', $serverRequest = true)
		{
			...
			$result = parent::unRegister(self::MD5_CODE);
		...
		{
			return \Bitrix\ImBot\Bot\Network::getNetworkBotId(self::MD5_CODE);
		}
	}
}
