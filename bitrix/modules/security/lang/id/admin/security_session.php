...
<p><i>Recommended for high level.</i></p>";
$MESS["SEC_SESSION_ADMIN_DB_WARNING"] = "Perhatian! Toggling the session mode on or off will cause currently authorized users to lose authorization (the session data will be destroyed).";
