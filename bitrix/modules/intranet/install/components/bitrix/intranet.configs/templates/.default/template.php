...
?>
	...
	?>
		<tr>
			<td class="content-edit-form-header " colspan="3">
				<div class="content-edit-form-header-wrap content-edit-form-header-wrap-blue"><?=GetMessage('CONFIG_SMTP_TITLE')?></div>
			</td>
		</tr>

		<tr>
			<td class="content-edit-form-field-name" style="width:370px; padding-right:30px"><?=GetMessage('CONFIG_SMTP_HOST')?></td>
			<td class="content-edit-form-field-input">
		...
		<tr>
			<td class="content-edit-form-field-name" style="width:370px; padding-right:30px"><?=GetMessage('CONFIG_SMTP_PORT')?></td>
			<td class="content-edit-form-field-input">
		...
		<tr>
			<td class="content-edit-form-field-name" style="width:370px; padding-right:30px"><?=GetMessage('CONFIG_SMTP_USER')?></td>
			<td class="content-edit-form-field-input">
		...
		<tr>
			<td class="content-edit-form-field-name" style="width:370px; padding-right:30px"><?=GetMessage('CONFIG_SMTP_PASSWORD')?></td>
			<td class="content-edit-form-field-input">
				<input type="password" name="smtp_password" value=""  class="content-edit-form-field-input-text"/>
			</td>
			<td class="content-edit-form-field-error"></td>
		</tr>

		<tr>
			<td class="content-edit-form-field-name" style="width:370px; padding-right:30px"><?=GetMessage('CONFIG_SMTP_REPEAT_PASSWORD')?></td>
			<td class="content-edit-form-field-input">
				<input type="password" name="smtp_repeat_password" value=""  class="content-edit-form-field-input-text"/>
			</td>
			<td class="content-edit-form-field-error"></td>
		</tr>

		<tr>
			<td class="content-edit-form-field-name" style="width:370px; padding-right:30px"><?=GetMessage('CONFIG_SMTP_EMAIL')?></td>
			<td class="content-edit-form-field-input">
		...
		<tr>
			<td class="content-edit-form-field-name" style="width:370px; padding-right:30px"><?=GetMessage('CONFIG_SMTP_TLS')?></td>
			<td class="content-edit-form-field-input">
				<input type="checkbox" name="smtp_tls" value="Y" <?if ($arResult["SCALE_SMTP_INFO"]["SMTPTLS"] == "Y"):?>checked<?endif;?> />
			</td>
			<td class="content-edit-form-field-error"></td>
		</tr>
	<?
...
<!-- logo -->
<?
if ($arResult["IS_BITRIX24"] && in_array($arResult["LICENSE_TYPE"], array("team", "company", "nfr", "edu")) || !$arResult["IS_BITRIX24"])
{
