...
//			}
		...
		if (isset($arParams["CUSTOM_ELEMENTS"]["ADD_BUTTON"]) || $arParams["SHOW_ADD_TASK_BUTTON"] === "Y")
		{
			...
			if (isset($arParams["CUSTOM_ELEMENTS"]["ADD_BUTTON"]))
			{
				...
				<span
					class="
						<?=$popup ? 'webform-small-button-separate-wrap webform-small-button-transparent' : ''?>
						webform-small-button tasks-add-button-wrapper">

					<a href="<?=$url?>"
					   class="webform-small-button webform-small-button-blue tasks-add-button" id="<?=$id?>-btn"><?=$name?></a>
