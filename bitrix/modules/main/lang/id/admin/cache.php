...
$MESS["MAIN_OPTION_CLEAR_CACHE_ALL"] = "Semua";
...
$MESS["MAIN_OPTION_CLEAR_CACHE_CLEAR"] = "Bersih";
...
</p>  Open the required page and refresh its objects by clicking a special update data button on the administrative toolbar.</p>
<img src=\"/bitrix/images/main/page_cache_en.png\" vspace=\"5\" />
</p>  When in Site Edit mode, you can click the clear cache button of a given component. </p>
<img src=\"/bitrix/images/main/comp_cache_en.png\" vspace=\"5\" />
</p>  Go to the component settings and switch the required components to uncached mode.</p>
...
$MESS["main_cache_files_start"] = "Mulai";
$MESS["main_cache_files_continue"] = "Terus";
