		...
		BX.ready(function()
		{
			...
			)
			{
				...
				)
				{
					...
					BXMobileApp.addCustomEvent("onImUpdateCounter", oMSL.onImUpdateCounterHandler);
					...
					BXMobileApp.addCustomEvent("onPull-main", BX.delegate(function(data)
					{
						...
						)
						{
							...
							oMSL.changeCounter(
								parseInt(data.params[BX.message("MSLSiteId")][strCounterType]),
								0,
								(typeof data.params.SERVER_TIME_WEB != 'undefined' ? parseInt(data.params.SERVER_TIME_WEB) : 0)
							);
						}
					}, this));
