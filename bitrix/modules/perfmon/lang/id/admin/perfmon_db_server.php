...
$MESS["PERFMON_KPI_NAME"] = "Nama";
$MESS["PERFMON_KPI_VALUE"] = "Nilai";
$MESS["PERFMON_KPI_RECOMENDATION"] = "Recommendation";
$MESS["PERFMON_KPI_NAME_VERSION"] = "Versi";
...
$MESS["PERFMON_KPI_NAME_UPTIME"] = "Waktu";
...
$MESS["PERFMON_KPI_NAME_CONNECTIONS"] = "Sambungan";
$MESS["PERFMON_KPI_REC_CONNECTIONS"] = "Max. connections (#VALUE#).";
$MESS["PERFMON_KPI_NAME_MEMORY"] = "Memori";
...
$MESS["PERFMON_KPI_NAME_LOCKS"] = "PENGUNCIAN";
...
$MESS["PERFMON_KPI_EMPTY"] = "kosong";
$MESS["PERFMON_KPI_NO"] = "tidak";
$MESS["PERFMON_KPI_NAME_INNODB_LOG_WAITS"] = "Log Buffer Waits";
$MESS["PERFMON_KPI_REC_INNODB_LOG_WAITS"] = "If greater than zero and growing, increase the value of <span class=\"perfmon_code\">innodb_log_file_size</span> (current value: #VALUE#). Penting First stop the web server, then stop MySQL. Change the parameter value in the settings file. Save existing log files in a temporary location. Start the server. If no error occurs, delete the old log files.";
