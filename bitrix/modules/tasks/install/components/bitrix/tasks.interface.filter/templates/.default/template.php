		...
		<? if ($arParams['USE_GROUP_SELECTOR'] == 'Y'): ?>
			...
			<div class="pagetitle-container pagetitle-flexible-space">
				<div id="<?=htmlspecialcharsbx($containerID)?>"
					...
					<div class="tasks-interface-toolbar-button-block">
						<span class="tasks-interface-toolbar-button-text"
							  id="<?=htmlspecialcharsbx($containerID)?>_text">
								<?=htmlspecialcharsbx($currentGroup['text'])?>
							</span>
						<span class="tasks-interface-toolbar-button-icon tasks-interface-toolbar-button-icon-arrow-down"></span>
					</div>
				</div>
			</div>
		...
		<div class="pagetitle-container pagetitle-align-right-container">
			...
			<?php if ($arParams['SHOW_USER_SORT'] == 'Y' ||
				...
				<div id="tasks-popupMenuOptions"
					 class="webform-small-button webform-small-button-transparent task-list-toolbar-lightning webform-cogwheel">
			...
			?>
			<span
				class="webform-small-button-separate-wrap webform-small-button-transparent webform-small-button tasks-add-button-wrapper">
				<?/*
			...
			<a href="<?=CComponentEngine::makePathFromTemplate(
			   ...
			   class="webform-small-button webform-small-button-blue tasks-add-button" id="tasks-buttonAdd"><?=GetMessage('TASKS_BTN_ADD_TASK')?></a>
