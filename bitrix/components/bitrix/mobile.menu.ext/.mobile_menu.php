	...
	array(
		...
		"items"=> array(
			...
			array(
				...
				"attrs"=>array(
					"onclick"=>"MobileMenu.diskList({type: 'user', entityId:".$GLOBALS['USER']->GetID()."}, '/');",
					"id"=>"doc_user",
				),
				"hidden"=> !$diskEnabled,
				"id"=>"doc_user",
			...
			array(
				"name"=>Loc::getMessage("MB_CURRENT_USER_FILES_MAIN_MENU_ITEM_NEW"),
				"attrs"=>array(
					"onclick"=>"MobileMenu.webdavList('user/".$GLOBALS['USER']->GetID()."/');",
					"id"=>"doc_user",
				),
				"hidden"=> $diskEnabled,
				"css_class"=> "menu-icon-disk",
			...
			array(
				...
				"hidden"=> !$diskEnabled || $isExtranetUser,
